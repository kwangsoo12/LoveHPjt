...
function fn_go(no) {
	...
	document.form1.search.value = '1';
	document.form1.keyWord.value =  '';
	document.form1.menu_id.value = no;
	document.form1.action = "<%=request.getContextPath()%>/getPageListNotice";
...
<form name="form1" method="post" action="<%=request.getContextPath()%>/getPageListNotice" target="_self" >
	...
	<c:forEach var="vo" items="${notice}">
	    <div class="row" >
		    	<div class="col">
					    <div class="row" >
					    		<div class="col">
									<h3 style="font-size:16px;font-family:'Noto Sans','맑은 고딕';color:#0E788D">${vo.notice_title}</h3>
								</div>
						</div>
						<br />
					    <div class="row" >
					    		<div class="col">
									<img class="card-img-top" src="resources/images/${vo.full_path}" style="width:100%" onclick="fn_go('${vo.link_page}')"/>
								</div>
						</div>
						<br />
				    	<div class="row" >
				    		<div class="col">
				    		    ...
				    		    <c:if test="${ str2 eq null}">
				    		    	<p style="font-size:15px;font-family:'Noto Sans','맑은 고딕';color:#333333"><strong>${vo.notice_content}</strong></p>
				    		    </c:if>
